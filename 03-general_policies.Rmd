...
* Accepted at a refereed journal co-authored with NM
  + first (co-first) or corresponding author: $500 one-time award in the student account
  + co-authors: $100 one-time award in student account
  + Accepted at exceptional journals (incentive = 1 in the [list](https://docs.google.com/spreadsheets/d/1tNzj1UMuvO9vShVRI0QanOSFvRSSd8Q5cm1ndOqWjYg/edit?gid=1450194090#gid=1450194090)): additional $500 one-time award to the first (co-first) or corresponding author
...
* Research Grant
  ...
  + Accepted grant: 10% of research grant income added to stipend as a one-time award. For example, if you get a [$2,500 grant](https://iussi.cyberbee.net/awards/), you will receive $250. The PI does not need to be a coauthor (Most student grants do not allow that).
...
2. **Undergraduates**
Undergraduate student pay rates usually begin at $12 per hour. Undergrads research assistants are expected to work more than 10 hours per week to have regular interactions. The time attending lab meeting or studying specific tools relating to their work can be counted towards working hour.
...
1. **Daily journal club**
  + Mizumoto lab has a daily journal club (Mon-Fri, 9:20am-9:50am at NM's office, as of Jan 2025). No preparation will be required other than downloading a pdf or printing it. We will read one paper together within 30 min. If you find a paper you want to read, add it to the [list](https://docs.google.com/spreadsheets/d/1oH9S6sksLE8oym9vj8eIPnwtD1yuOtqDAbN96wR89H0/edit?gid=0#gid=0). Any papers are welcome. Do you have papers you need to read for your assignments, writing, or studying? Put them in the list. They do not need to be a good paper.
...
2. **Lab meeting**
  + The goal of the lab meetings is to provide meaningful updates that directly contribute to the development of thesis or paper. Each meeting will focus on discussing a single figure, which could represent either results or concepts. This format ensures that updates are purposeful, and that feedback directly supports academic progress.
  + Figure presentation
    + Presenter presents at least one figure that could be used as part of their thesis or paper.
    + The figure can represent anything such as methods, results or concepts.
  + Document preparation
    + Presenter will prepare a 1–2-page document to accompany the figure, which should include:
      + Background: Introduction information for the figure
      + Methods: Explanation about the data collection
      + Results: Explain the figure.
      + Figure Legend: Detailed explanation of the figure 
      + So, this is very similar to our format of Daily journal club. Make sure prepare documents which can be directly used to paper/thesis. **Do not prepare for the meeting. Meeting is the regular opportunity to make a progress on paper/thesis**.
  + Meeting Frequency & Duration
    + Each person presents **every 4 weeks**. (you can get ~ 10 figures for your thesis/paper)
    + Each meeting lasts 30-60 min. We use the time of journal club on Friday.
  + Pre-meeting preparation
    + Send the document and figure to the lab members by 11:59pm on the day before.
  + Discussion format
    + Read the document in 5 minutes.
    + Presenter explains the figure with context and relavance.
    + Discuss figures and documents, focusing on constructive feedback for imporvements and next steps.
...
NM usually writes in the morning (7:20-9:20 am) if there is no other schedule. Except for this time, NM is available for any kind of meeting with lab members until 5:30 pm. All other schedules are in my Outlook calendar (nzm0095@auburn.edu), and thus, you can freely add meeting schedules with me on the vacant spots. You do not need to ask me to add it if you schedule it by 5 am of the day.  
